      ...
      <Card className={className}>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button onClick={() => setShowTour(true)} variant="default">
        ...
        <CardContent>
          <div
            className="relative aspect-video bg-gradient-to-br from-purple-100 to-blue-100 rounded-lg overflow-hidden cursor-pointer group"
          ...
          >
            ...
            <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center group-hover:bg-opacity-40 transition-all">
              <div className="text-center text-white">
                <div className="w-16 h-16 rounded-full bg-white bg-opacity-20 backdrop-blur-sm flex items-center justify-center mb-2 mx-auto group-hover:scale-110 transition-transform">
                  <Camera className="h-8 w-8" />
                </div>
                <p className="text-sm font-medium">Haz click para explorar</p>
                <p className="text-xs opacity-80">Recorrido virtual interactivo</p>
              </div>
            </div>
          </div>
