...
export async function GET(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const requestDetail = {
      ...
      tenantEmail: 'N/A',
      tenantPhone: 'N/A',
      ownerName: maintenance.property.owner?.name || 'No asignado',
      ownerEmail: maintenance.property.owner?.email || 'No asignado',
      ownerPhone: maintenance.property.owner?.phone || 'No asignado',
