  ...
  const features = [
    {
      ...
      description: 'Validación de identidad y documentos para propietarios e inquilinos con verificación completa.',
    },
    {
      icon: FileText,
      title: 'Contratos Digitales',
      description: 'Firma electrónica de contratos con validez legal, seguros y siempre accesibles.',
    },
    {
      icon: CreditCard,
      title: 'Pagos Seguros',
  ...
  const testimonials = [
    {
      name: 'María González',
      role: 'Propietaria',
      content: 'Como administradora, la plataforma me permite gestionar todos los arriendos de forma eficiente y segura.',
      rating: 5,
    },
    {
      name: 'Carlos Ramírez',
      role: 'Inquilino',
      content: 'Encontré el departamento perfecto y todo el proceso fue transparente. ¡Excelente servicio!',
      rating: 5,
    },
    {
      name: 'Ana Martínez',
      role: 'Corredora',
      content: 'La plataforma me ha ayudado a conectar propietarios con inquilinos de manera más profesional.',
      rating: 4.5,
    },
  ];
    ...
    <div className="min-h-screen">
        ...
        <div className="relative container mx-auto px-4 py-24 md:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-emerald-100 max-w-3xl mx-auto">
              Gestiona, arrienda y encuentra propiedades con la seguridad y transparencia que mereces. 
              La plataforma completa para propietarios, inquilinos y corredores.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600">
              Diseñada para simplificar cada aspecto del proceso de arriendo, desde la búsqueda hasta la firma del contrato.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { step: 1, title: 'Regístrate', description: 'Crea tu cuenta como propietario, inquilino o corredor en minutos.' },
              { step: 2, title: 'Verifica', description: 'Sube tus documentos y completa tu perfil para mayor confianza.' },
              { step: 3, title: 'Publica o Busca', description: 'Propietarios publican, inquilinos encuentran su hogar ideal.' },
              { step: 4, title: 'Gestiona', description: 'Firma contratos digitales, gestiona pagos y comunica.' },
            ].map((item, index) => (
              <Card key={index} className="text-center border-0 shadow-lg">
                <CardHeader>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-emerald-100">
              Miles de propietarios e inquilinos ya están usando Rent360 para gestionar sus arriendos de manera eficiente y segura.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-300">
              Ofrece visitas presenciales a propiedades y gana dinero flexibilizando tu horario. 
              Sé parte de la red de confianza de Rent360.
            </p>
