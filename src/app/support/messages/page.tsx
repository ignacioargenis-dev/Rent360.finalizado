...
export default function SupportMessagesPage() {
  ...
  const loadPageData = async () => {
    try {
      ...
      const supportMessages = transformedMessages.filter(
        m => m.type === 'support' || m.type === 'ticket'
      ).length;
      ...
      setStats({
        ...
        todayMessages,
        urgentMessages,
        responseRate: 98, // TODO: Calculate from real data
        averageResponseTime: 1.2, // TODO: Calculate from real data
        openTickets: supportMessages,
      });

      logger.debug('Datos de mensajería de soporte cargados', {
        totalMessages,
        unreadMessages,
        todayMessages,
        urgentMessages,
      ...
      logger.error('Error loading support messages data:', {
    ...
    try {
      ...
      const response = await fetch('/api/messages', {
        ...
        body: JSON.stringify({
          ...
          subject: recipientData ? 'Respuesta de soporte' : 'Mensaje del sistema',
  ...
  if (loading) {
    return (
      <UnifiedDashboardLayout
        ...
        subtitle="Gestión de mensajes y tickets de soporte"
      >
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4"></div>
            <p className="text-gray-600">Cargando mensajes de soporte...</p>
          </div>
        </div>
      </UnifiedDashboardLayout>
    );
  ...
  return (
    ...
    >
      <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <div className="relative">
                  ...
                  <Input
                    placeholder="Buscar mensajes de soporte..."
                    value={searchTerm}
        ...
        <Card>
          <CardHeader>
            <CardTitle>Mensajes de Soporte ({filteredMessages.length})</CardTitle>
            <CardDescription>Gestiona todos los mensajes y tickets de soporte</CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          {message.type === 'ticket' && (
                            <Badge className="bg-orange-100 text-orange-800 text-xs">Ticket</Badge>
                          )}
                        </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Nueva Respuesta de Soporte</CardTitle>
            <CardDescription>Envía una respuesta de soporte a usuarios</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div>
