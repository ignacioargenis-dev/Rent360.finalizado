...
export default function AdminPaymentsProvidersPage() {
  ...
  const handleNewPayment = () => {
    ...
    window.location.href = '/admin/payments/providers/new';
  };
  ...
  const filteredPayouts = payouts.filter(payout => {
    const matchesSearch =
      ...
      payout.clientName.toLowerCase().includes(searchTerm.toLowerCase()) ||
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          <div className="flex-1">
            <div className="relative">
              ...
              <Input
                placeholder="Buscar pagos por proveedor, descripción, cliente o dirección..."
                value={searchTerm}
