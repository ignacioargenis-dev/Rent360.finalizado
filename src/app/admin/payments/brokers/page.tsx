...
export default function AdminPaymentsBrokersPage() {
  ...
  useEffect(() => {
    ...
    const loadPayoutData = async () => {
      try {
        // Mock broker payouts data
        const mockPayouts: BrokerPayout[] = [
          {
            id: '1',
            ...
            description: 'Comisión por arriendo marzo 2024',
            dealValue: 450000,
            commissionRate: 5,
            netAmount: 22500,
          ...
          },
          {
            ...
            status: 'processing',
            period: '2024-02',
            description: 'Comisión por arriendo febrero 2024',
            dealValue: 480000,
            commissionRate: 5,
            netAmount: 24000,
            paymentMethod: 'digital_wallet',
            invoiceNumber: 'PB-2024-003',
          },
          {
            id: '4',
            brokerName: 'Ana Martínez',
          ...
          },
          {
            ...
            status: 'failed',
            period: '2024-03',
            description: 'Comisión por arriendo marzo 2024 - Pago rechazado',
            dealValue: 350000,
            commissionRate: 5,
            netAmount: 17500,
            paymentMethod: 'bank_transfer',
            invoiceNumber: 'PB-2024-005',
          },
        ];

        // Obtener datos reales de pagos a corredores desde la API
        const response = await fetch('/api/admin/payments/brokers');
        if (response.ok) {
          const data = await response.json();
          ...
          logger.warn('Failed to fetch real broker payouts, using mock data');
  ...
  const handleExportPayments = () => {
    ...
    link.setAttribute('download', `pagos_corredores_${new Date().toISOString().split('T')[0]}.csv`);
  ...
  const handleViewPayment = (paymentId: string) => {
    ...
    window.open(`/admin/payments/brokers/${paymentId}`, '_blank');
  };

  const handleEditPayment = (paymentId: string) => {
    // Navigate to payment edit page
    window.open(`/admin/payments/brokers/${paymentId}/edit`, '_blank');
  };

  const filteredPayouts = payouts.filter(payout => {
    const matchesSearch =
      payout.brokerName.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Cargando pagos a corredores...</p>
        </div>
      </div>
    );
  }
    ...
    >
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Pagos a Corredores</h1>
            <p className="text-gray-600">
              Administra comisiones y pagos a corredores inmobiliarios
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          <div className="flex-1">
            <div className="relative">
              ...
              <Input
                placeholder="Buscar pagos por corredor, descripción o dirección..."
                value={searchTerm}
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Todas las comisiones pagadas a corredores</CardDescription>
              </CardHeader>
              <CardContent>
                          ...
                          <div className="flex items-start gap-3 flex-1">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-2">
                                <h3 className="font-semibold text-gray-900">{payout.brokerName}</h3>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                <div>
                                  ...
                                  <div className="flex items-center gap-2 text-sm text-gray-600 mb-1">
                                    ...
                                    <span>Propietario: {payout.ownerName}</span>
                                  </div>
                                ...
                                <div>
                                  <div className="flex items-center gap-2 text-sm text-gray-600 mb-1">
                                    ...
                                    <span>
                                      Valor Negocio:{' '}
                                      {formatCurrency(payout.dealValue, payout.currency)}
                                    </span>
                                  </div>
                                  <div className="flex items-center gap-2 text-sm text-gray-600 mb-1">
                                    <TrendingUp className="w-4 h-4" />
                                    <span>
                                      Comisión: {payout.commissionRate}% (
          ...
          <div>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Métricas y estadísticas de pagos a corredores</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    <div>
                      <p className="text-sm font-medium text-green-800">Comisiones Este Mes</p>
