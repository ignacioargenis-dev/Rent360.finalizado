...
params.append('verified', verifiedFilter);
      ...
      logger.error('Error fetching contractors:', { error: error instanceof Error ? error.message : String(error) });
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleCreateContractor = async () => {
    try {
      ...
      logger.error('Error creating contractor:', { error: error instanceof Error ? error.message : String(error) });
    }
  };
...
return;
    ...
    try {
      ...
      logger.error('Error updating contractor:', { error: error instanceof Error ? error.message : String(error) });
    }
  };
...
return;
    ...
    try {
      ...
      logger.error('Error deleting contractor:', { error: error instanceof Error ? error.message : String(error) });
    }
  };
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-1">
                            <span className="text-lg font-bold">{contractor.rating.toFixed(1)}</span>
