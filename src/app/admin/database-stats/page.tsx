...
export default function EstadísticasdeBasedeDatosPage() {
  ...
  return (
    <UnifiedDashboardLayout
      title="Estadísticas de Base de Datos"
      subtitle="Gestiona y visualiza la información de estadísticas de base de datos"
    >
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Aquí puedes gestionar y visualizar toda la información relacionada con estadísticas de
              base de datos.
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <QuickActionButton
                ...
                onClick={() => alert('Funcionalidad: Nueva consulta de base de datos')}
              />

              <QuickActionButton
                icon={Filter}
                label="Filtrar"
                description="Buscar estadísticas"
                onClick={() => alert('Funcionalidad: Abrir filtros de estadísticas')}
              />
              ...
              <QuickActionButton
                ...
                onClick={() => alert('Funcionalidad: Exportar estadísticas de base de datos')}
              />
              ...
              <QuickActionButton
                ...
                onClick={() => router.push('/admin/reports/database')}
              />
