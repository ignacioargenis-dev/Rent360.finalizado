...
export default function EstadísticasdeBasedeDatosPage() {
  ...
  if (loading) {
    return (
      <UnifiedDashboardLayout title="Estadísticas de Base de Datos" subtitle="Cargando información...">
  ...
  if (error) {
    return (
      <UnifiedDashboardLayout title="Estadísticas de Base de Datos" subtitle="Error al cargar la página">
        <Card>
  ...
  return (
    <UnifiedDashboardLayout title="Estadísticas de Base de Datos" subtitle="Gestiona y visualiza la información de estadísticas de base de datos">
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Aquí puedes gestionar y visualizar toda la información relacionada con estadísticas de base de datos.
            </CardDescription>
          </CardHeader>
          <CardContent>
