    ...
    try {
      ...
      const response = await fetch('/api/ratings', {
        ...
        body: JSON.stringify({
          ...
          overallRating: ratings[RatingType.OVERALL] || 0,
          punctualityRating: ratings[RatingType.PUNCTUALITY] || undefined,
          professionalismRating: ratings[RatingType.PROFESSIONALISM] || undefined,
          communicationRating: ratings[RatingType.COMMUNICATION] || undefined,
          qualityRating: ratings[RatingType.QUALITY_OF_WORK] || undefined,
          reliabilityRating: ratings[RatingType.CLEANLINESS] || undefined,
