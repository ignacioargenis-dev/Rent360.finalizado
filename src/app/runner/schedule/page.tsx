...
export default function HorarioPage() {
  ...
  if (loading) {
    return (
      <DashboardLayout title="Horario" subtitle="Cargando información...">
  ...
  if (error) {
    return (
      <DashboardLayout title="Horario" subtitle="Error al cargar la página">
        <Card>
  ...
  return (
    <DashboardLayout title="Horario" subtitle="Gestiona y visualiza la información de horario">
