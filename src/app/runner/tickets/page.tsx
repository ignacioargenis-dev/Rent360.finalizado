...
export default function RunnerTicketsPage() {
  const { user } = useAuth();
  ...
  if (!user) {
    return (
      <UnifiedDashboardLayout
        title="Mis Tickets"
        subtitle="Gestiona tus consultas sobre visitas y soporte"
      >
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">Gestiona tus consultas sobre visitas y soporte</p>
          </div>
