      ...
      const mockProperties = [
        {
          ...
          area: 85,
          status: 'AVAILABLE',
          images: JSON.stringify(['/placeholder1.jpg', '/placeholder2.jpg']),
          features: JSON.stringify(['Estacionamiento', 'Seguridad 24h', 'Gimnasio', 'Piscina']),
          ownerId: 'user1',
        ...
        },
        {
          ...
          area: 180,
          status: 'RENTED',
          images: JSON.stringify(['/placeholder3.jpg', '/placeholder4.jpg']),
          features: JSON.stringify(['Jardín', 'Terraza', 'Estacionamiento', 'Seguridad']),
          ownerId: 'user1',
