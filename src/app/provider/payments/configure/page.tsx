...
export default function ConfigureBankAccountPage() {
  ...
  return (
    <UnifiedDashboardLayout
      ...
      subtitle="Configura tu cuenta para recibir pagos"
    >
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        <Button variant="ghost" onClick={() => router.push('/provider/earnings')} className="mb-4">
