    ...
    >
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Gestiona y visualiza la información de clientes activos</p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Aquí puedes gestionar y visualizar toda la información relacionada con clientes activos.
            </CardDescription>
          </CardHeader>
          <CardContent>
