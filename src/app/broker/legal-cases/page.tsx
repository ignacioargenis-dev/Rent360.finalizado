...
export default function BrokerLegalCasesPage() {
  ...
  const loadLegalCases = async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/broker/legal-cases?status=${statusFilter}`);
      if (response.ok) {
  ...
  return (
    <UnifiedDashboardLayout
      title="Casos Legales"
      subtitle="Gestiona casos legales en contratos donde eres intermediario"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Mis Casos</CardTitle>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Mediación posible</p>
            </CardContent>
          </Card>
        </div>
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between text-xs text-gray-500">
                        <span>Inicio: {formatDate(legalCase.firstDefaultDate)}</span>
