...
export default function DiscoverClientsPage() {
  ...
  return (
    <UnifiedDashboardLayout
      title="🔍 Descubrir Clientes"
      subtitle="Encuentra propietarios e inquilinos potenciales usando herramientas inteligentes"
    >
              ...
              <div className="flex items-center gap-4 mb-4">
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={e =>
                      setSearchFilters({ ...searchFilters, noBroker: e.target.checked })
                    }
                    className="rounded"
                  />
