    ...
    const loadCommissions = async () => {
      try {
        ...
        const mockCommissions: Commission[] = [
          {
            ...
            percentage: 5,
            status: 'paid',
            dueDate: new Date(Date.now() - 1000 * 60 * 60 * 24 * 10).toISOString().substring(0, 10),
          ...
          },
          {
            ...
            percentage: 4,
            status: 'approved',
            dueDate: new Date(Date.now() + 1000 * 60 * 60 * 24 * 5).toISOString().substring(0, 10),
          ...
          },
          {
            ...
            percentage: 4,
            status: 'pending',
            dueDate: new Date(Date.now() + 1000 * 60 * 60 * 24 * 15).toISOString().substring(0, 10),
          ...
          },
          {
            ...
            percentage: 3,
            status: 'paid',
            dueDate: new Date(Date.now() - 1000 * 60 * 60 * 24 * 30).toISOString().substring(0, 10),
        ...
        const sortedTypes = Object.entries(propertyTypeCount)
          .sort(([,a], [,b]) => b - a);
        const topPropertyType = sortedTypes.length > 0 ? sortedTypes[0]![0] : '';
