...
export default function BrokerPropertyEditPage() {
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {/* New Image Previews */}
                {imagePreviews.length > formData.images.length && (
                  <div className="space-y-2">
                    <Label>Nuevas Imágenes ({newImages.length})</Label>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      {imagePreviews.slice(formData.images.length).map((preview, index) => (
                ...
                {(!formData.images || formData.images.length === 0) &&
                  imagePreviews.length === 0 && (
                    <div className="text-center py-8 text-gray-500">
                      ...
                      <p className="text-sm">Sube imágenes para mostrar la propiedad</p>
                    </div>
                  )}
              </CardContent>
            </Card>
