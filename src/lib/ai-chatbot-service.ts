...
export class AIChatbotService {
  ...
  private async processWithLocalLogic(
    ...
    // 🚀 MEJORADO: Detección específica para registro de proveedores - MOVER ANTES DE PAGOS
    ...
    const quiereOfrecer =
      ...
      (input.includes('puedo') && input.includes('mediante')) ||
      (input.includes('puedo') && input.includes('web')) ||
      (input.includes('puedo') && input.includes('plataforma'));
    ...
    // Caso 1: "soy jardinero, puedo ofrecer mis servicios?"
