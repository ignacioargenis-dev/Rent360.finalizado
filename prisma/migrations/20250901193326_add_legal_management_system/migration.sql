...
CREATE TABLE "legal_cases" (
    ...
    "firstDefaultDate" TIMESTAMPTZ NOT NULL,
    "lastPaymentDate" TIMESTAMPTZ,
    "extrajudicialSentDate" TIMESTAMPTZ,
    "demandFiledDate" TIMESTAMPTZ,
    "hearingDate" TIMESTAMPTZ,
    "judgmentDate" TIMESTAMPTZ,
    "evictionDate" TIMESTAMPTZ,
    "caseClosedDate" TIMESTAMPTZ,
    "currentPhase" TEXT NOT NULL DEFAULT 'PRE_JUDICIAL',
    "nextDeadline" TIMESTAMPTZ,
    "notes" TEXT,
    "internalNotes" TEXT,
...
CREATE TABLE "court_proceedings" (
    ...
    "oppositionDeadline" TIMESTAMPTZ,
    "hearingDate" TIMESTAMPTZ,
    "evidenceDeadline" TIMESTAMPTZ,
    "judgmentDeadline" TIMESTAMPTZ,
    "outcome" TEXT,
    "judgmentText" TEXT,
    "judgmentDate" TIMESTAMPTZ,
    "appealDeadline" TIMESTAMPTZ,
    "appealFiled" BOOLEAN NOT NULL DEFAULT false,
    "appealDate" TIMESTAMPTZ,
    "courtFees" REAL NOT NULL DEFAULT 0,
    "legalFees" REAL NOT NULL DEFAULT 0,
